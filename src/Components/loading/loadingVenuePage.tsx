export default function LoadingVenuePage () {
    return (
        <section className="flex max-w-[1250px] animate-pulse" aria-hidden="true">
            <div className="imageAndPriceWrapper flex flex-col gap-16">
                 <div className="imageContainer flex flex-col gap-5">
                <div className="mainImage max-w-[530px] h-[440px] bg-[#C4C4C4] rounded-xl"></div>
                <div className="smallImageWrapper flex justify-between">
                    <div className="image1 w-[95px] h-[85px] bg-[#C4C4C4] rounded-xl"></div>
                    <div className="image2 w-[95px] h-[85px] bg-[#C4C4C4] rounded-xl"></div>
                    <div className="image3 w-[95px] h-[85px] bg-[#C4C4C4] rounded-xl"></div>
                    <div className="image4 w-[95px] h-[85px] bg-[#C4C4C4] rounded-xl"></div>
                </div>
                    </div>
                 <div className="priceContainer flex flex-col gap-5">
                        <div className="price w-[125px] h-[30px] bg-[#C4C4C4] rounded-xl"></div>
                        <div className="nights w-[70px] h-[20px] bg-[#C4C4C4] rounded-xl"></div>
                        <div className="checkIn-Out-Inputs flex w-[530px] justify-between">
            ...
            <div className="infoWrapper flex flex-col w-[720px] md:ml-20 gap-5">
